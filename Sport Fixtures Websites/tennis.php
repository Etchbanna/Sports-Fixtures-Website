...
<body>
  ...
  <div class="MainBody">
    <div class="fixtures">
      <span><img style="height:50px;width:50px" src="tennis/goffin.png"> David Goffin vs </span> <span> Karen Khachanov <img style="height:50px;width:50px" src="tennis/karen.png"> </span>
      <div class="matchdata"  id="FMDATA" onmouseover="showDetails(this);" onmouseout="hideDetails(this);">
        Location: Jockey Club Brasileiro, Brazil	- <span id="time" style="font-size:16px"></span>
        <img id="arrow1" src="arrowdown.png" style="color:yellow; width:20px; height:15px; position: relative;left:280px; top:20px">
    ...
    <div class="fixtures">
      <span><img style="height:50px;width:50px" src="tennis/gael.png" > Gael Monfils vs</span> <span> Denis Shapovalov <img style="height:50px;width:50px" src="tennis/denis.png"></span>
      <div class="matchdata" onmouseover="showDetails2(this);" onmouseout="hideDetails2(this);">
      Location: Roy Emerson Arena, Switzerland -  <span id="time2" style="font-size:16px"></span>
        <img id="arrow2" src="arrowdown.png" style="color:yellow; width:20px; height:15px; position: relative;left:280px; top:20px">
  ...
  <div class="LeftPane">
    <div class="Sports menu">
      ...
      <a href="#dww" style="display:block; color:blue"> Tennis </a>
  ...
  var date1 = new Date("Jul 28, 2021 13:00:00");
  var date2 = new Date("Jul 30, 2021 15:00:50");
