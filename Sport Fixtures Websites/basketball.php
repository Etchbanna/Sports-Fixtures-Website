...
<body>
  ...
  <div class="MainBody">
    ...
    <div class="fixtures">
      ...
      <span><img src="basketball/lakersflag.png"> Los Angeles Lakers vs </span> <span> Cleveland Cavaliers <img src="basketball/cavaliers.jpg"> </span>
      <div class="matchdata" id="FMDATA" onmouseover="showDetails(this);" onmouseout="hideDetails(this);">
        Location: Barclays Center, New York, USA - <span id="time" style="font-size:16px"></span>
    ...
    <div class="fixtures">
      <span><img src="basketball/raptors.png" > Toronto Raptors vs</span> <span> Charlotte Hornets <img src="basketball/hornets.png"></span>
      <div class="matchdata" onmouseover="showDetails2(this);" onmouseout="hideDetails2(this);">
          Location: Target Center, Minnesota, USA -  <span id="time2" style="font-size:16px"></span>
  ...
  <div class="LeftPane">
    <div class="Sports menu">
      ...
      <a href="Basketball.php" style="display:block; color:blue"> Basketball </a>
  ...
  <script>
  var date1 = new Date("Jul 15, 2021 14:00:00");
  var date2 = new Date("Jul 20, 2021 20:00:00");
